...
BASE = "http://35.90.152.140:8080/carts"
...
for i in range(50):
    start = time.time()
    resp = requests.post(BASE, json={"customer_id": 2000 + i}, timeout=10)
...
print("Saved to mysql_test_results.json")